...
def load_dataset(fold, task, SNP_mapping=True, return_tensor=False):
    ...
    Y_dis = np.eye(np.unique(y_labels).shape[0])[y_labels]
    ...
    return X_MRI_tr, X_PET_tr, X_SNP_tr, C_dmg_tr, Y_dis_tr, S_cog_tr, X_MRI_val, X_PET_val, X_SNP_val, C_dmg_val, \
           Y_dis_val, S_cog_val, X_MRI_ts, X_PET_ts, X_SNP_ts, C_dmg_ts, Y_dis_ts, S_cog_ts
